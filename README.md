<p align="center">
  <a href="https://github.com/whbexc/Zugzwang">
    <img src="src/ui/assets/logo-mark.png" alt="ZUGZWANG Logo" width="120" style="border-radius: 22px;">
  </a>
</p>
...
<table>
  <tr>
    ...
    <td width="50%" valign="top">
      <img src="screenshot_search_clean.png" alt="Search Interface" width="100%" style="border-radius: 8px;">
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top">
      <img src="screenshot_results_clean.png" alt="Lead Intelligence Table" width="100%" style="border-radius: 8px;">
    </td>
    <td width="50%" valign="top">
  ...
  <tr>
    ...
    <td width="50%" valign="top">
      <img src="screenshot_edit_clean.png" alt="Cover Letter Editor" width="100%" style="border-radius: 8px;">
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top">
      <img src="screenshot_send_clean.png" alt="Email Sender" width="100%" style="border-radius: 8px;">
    </td>
    <td width="50%" valign="top">
  ...
  <tr>
    ...
    <td width="50%" valign="top">
      <img src="screenshot_monitor_clean.png" alt="Live Monitor" width="100%" style="border-radius: 8px;">
    </td>
  </tr>
</table>
